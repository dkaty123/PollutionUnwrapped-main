...
def display_mismanagedWaste_map(year):
  ...
  if year == 2010:
    ...
    fig = px.choropleth_mapbox(mismanaged_waste_gdf,
                              geojson = mismanaged_waste_gdf.geometry,
                              locations = mismanaged_waste_gdf.index,
                              color = 'Total Mismanaged Plastic Waste 2025 (millions)',
                              hover_name = mismanaged_waste_gdf['Country'],
                              color_continuous_scale = color_scale,
                              zoom = 1, mapbox_style = 'carto-positron',height = 425)
    fig.update_layout(
...
app.layout = html.Div([
    ...
    #Main Graph
    html.H1('Pollution Unwrapped', style ={'font-weight':'bold',
                                                'text-align':'center',
                                                'margin': '25px 0px',
                                                'padding-bottom':'20px',
      ...
      dbc.Container(
          ...
          [
              ...
              html.Div([
                    ...
                    dcc.Dropdown(['2010','2025'],'2010', style = {'width': '100px', 'text-align': 'center', 'margin-right': '20px'}, id = 'year_dd',clearable = False)
...
#Sub Graphs
      ...
      dbc.Container(
          html.Div([
              #Sub Graph 1
              html.Div([
                  html.H4('Mismanaged Plastic Waste Per Continent, 2010 vs 2025', style = {'text-align':'center'}),
              ...
              # Sub Graph 2
              html.Div([
                  html.H4(('Total Mismanaged Waste and Plastic Pollution Per Country, 2025'),style = {'text-align':'center'}),
                  html.P(('The data represents the total mismanaged waste (millions), and the annual estimate of plastic polluton emitted in the ocean (kg per person) in 2025'),style = {'text-align':'center', 'word-wrap':'break-word'}),
